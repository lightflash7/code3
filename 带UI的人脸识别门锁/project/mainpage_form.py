...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.delect_button = QtWidgets.QPushButton(Form)
        self.delect_button.setGeometry(QtCore.QRect(960, 400, 121, 51))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(16)
        self.delect_button.setFont(font)
        self.delect_button.setObjectName("delect_button")
    ...
    def retranslateUi(self, Form):
        ...
        self.delect_button.setText(_translate("Form", "删减成员"))
